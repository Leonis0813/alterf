...
library(yaml)
config <- yaml.load_file("/home/developer/alterf/scripts/analyze/settings.yml")
...
filename <- paste("/home/developer/alterf/scripts/results/", paste(timestamp, num_training_data, ntree, mtry, sep="_"), sep="")
...
save(model, file=paste("/home/developer/alterf/scripts/results/", timestamp, ".rf", sep=""))
